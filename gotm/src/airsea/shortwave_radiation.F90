...
!
! !INTERFACE:
   REALTYPE function shortwave_radiation(zenith_angle,yday,dlon,dlat,cloud,seaice)  !!YSK
!
! !DESCRIPTION:
...
! !INPUT PARAMETERS:
   ...
   REALTYPE, intent(in)                :: cloud, seaice   !!YSK
!
! !REVISION HISTORY:
...
!  clouds from COADS perpetual data set
   ...
   qshort  = qtot*(1-0.62*cloud + .0019*sunbet)*(1-0.544*seaice)   !-0.058)  !intercept-0.058 !Sea ice Albedo : Allison 1993
